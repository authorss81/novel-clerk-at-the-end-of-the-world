...
- **Method:** Revives the **Assumption Plan**: under a global emergency, the Chancellor may sign for absent, incapacitated, or unreachable people. This is Lound’s institutional authority, distinct from Owen’s community-selected transmission role. Her institutional mark can obtain a 30-day succession hold at the Mandate’s final transition, keeping central infrastructure at its last supported status. Her intended route to permanence is a day-twenty-five renewal filing that pools the Council and every essential service into one institutional branch, then uses Owen’s pooled transmission mark to make the false representative line pass the seal’s first structural check. The renewal is a gamble, not a lawful promotion: essential-service acts do not authorize the residents Lound claims, so without Owen’s mark a supported counter-entry exposes the false scope at the next ledger stroke. If a valid Common Return activates at Civic Zero, it immediately supersedes the initial hold and stops its 30-day term before Lound’s renewal can mature.

Lound is not secretly manipulating the apocalypse. She believes the apocalypse, wants to prevent it, and is willing to make all private consent revocable to do so. She knows the distinction between a temporary emergency bridge and a valid return, as well as the mechanical weakness in her renewal scheme. She has decided that a controlled interval of centralized rule is worth a permanent loss of refusal, and intends to make de facto control look lawful before the first counter-entry can break it. Her record shows competent emergency decisions and decisions that harmed people for decades. She is Owen’s ideological mirror: both believe a final accountable person may be necessary; Owen eventually learns to act without that certainty.
